...
class ApplicationBehavior extends Behavior {
    ...
    onLaunch() {
        let credentials = Files.readJSON(mergeURI(application.url, "./credentials.json"));
        CLIENT_ID = credentials.clientID;
        CLIENT_SECRET = credentials.clientSecret;
        this.accessToken = ACCESS_TOKEN = credentials.accessToken;
        this.refreshToken = REFRESH_TOKEN = credentials.refreshToken;

...
/*
*
* This is an updated JavaScript version of the the transitions.xml module from the Transitions library
* https://github.com/Kinoma/kinomajs/blob/master/kinoma/kpr/libraries/Transitions/src/transitions.xml
*
* Notes: 
*

...
export class DynamicSkin extends Skin {
	constructor(texture, disabledEffect, enabledEffect, selectedEffect, variantWidth, tiles, margins, aspect) {
		...
		super(result, {x:0, y:0, width:height, height:height}, width, height, tiles, margins, aspect);
...
let dialogButtonsSkin = new DynamicSkin(dialogButtonsTexture, dialogDisabledEffect, dialogEnabledEffect, dialogSelectedEffect);
...
export var MediaController = Container.template($ => ({ 
	...
	Behavior: MediaControllerBehavior, 
	contents: [

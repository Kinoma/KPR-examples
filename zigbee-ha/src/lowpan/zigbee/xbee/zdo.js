...
var logger = new Utils.Logger("XBee ZDO");
	...
	API.executeCommandSequence(
		INIT_COMMAND_SEQ,
		{
			sequenceCompleted: function (responseMap) {
				deviceInfo = readBasicInformations(responseMap);
				logger.info(deviceInfo.name + " device is detected.");
				logger.info("NodeType: " + deviceInfo.nodeType);
				logger.info("IEEEAddress: " + deviceInfo.ieeeAddress.toString());
				// TODO: Notify to delegate
			},

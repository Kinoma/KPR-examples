...
<x-app-info id="analogdrawingtoy.example.kinoma.marvell.com"><span class="createSample samplePage"></span></x-app-info>
...
<x-app-info id="analoggraph.example.kinoma.marvell.com"><span class="createSample samplePage"></span></x-app-info>
...
<x-app-info id="analogkinomaxively.example.kinoma.marvell.com"><span class="createSample samplePage"></span></x-app-info>
...
<x-app-info id="analogstarter.example.kinoma.marvell.com"><span class="createSample"></span></x-app-info>
...
<x-app-info id="analogtemperature.example.kinoma.marvell.com"><span class="createSample"></span></x-app-info>
...
<x-app-info id="audiorecorderplayer.example.kinoma.marvell.com"><span class="createSample samplePage"></span></x-app-info>
...
<x-app-info id="bllrepeat.example.kinoma.marvell.com"><span class="createSample"></span></x-app-info>
...
<x-app-info id="bllrun.example.kinoma.marvell.com"><span class="createSample"></span></x-app-info>
...
<x-app-info id="dialclient.example.kinoma.marvell.com"><span class="createSample"></span></x-app-info>
...
<x-app-info id="dialremote.example.kinoma.marvell.com"><span class="createSample"></span></x-app-info>
...
<x-app-info id="digitallightwebsocketsclient.example.kinoma.marvell.com"><span class="createSample samplePage"></span></x-app-info>
...
<x-app-info id="digitallightwebsocketsserver.example.kinoma.marvell.com"><span class="createSample"></span></x-app-info>
...
<x-app-info id="digitaloutled.example.kinoma.marvell.com"><span class="createSample samplePage"></span></x-app-info>
...
<x-app-info id="fileschunks.example.kinoma.marvell.com"></x-app-info>
...
<x-app-info id="i2ccolorsensor.example.kinoma.marvell.com"><span class="createSample samplePage"></span></x-app-info>
...
<x-app-info id="i2chover.example.kinoma.marvell.com"><span class="createSample"></span></x-app-info>
...
<x-app-info id="i2ctemperature.example.kinoma.marvell.com"><span class="createSample samplePage"></span></x-app-info>
...
<x-app-info id="pwmtricolorled.example.kinoma.marvell.com"><span class="createSample samplePage"></span></x-app-info>
...
<x-app-info id="serialcamera.example.kinoma.marvell.com"><span class="createSample"></span></x-app-info>
...
<x-app-info id="sketchat.create.kinoma.marvell.com"><span class="createSample"></span></x-app-info>
